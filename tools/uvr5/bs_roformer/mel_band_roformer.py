"""Mel-Band Roformer source-separation model. forward uses einops notation: b batch, f freq, t time, s audio channel (1 mono / 2 stereo), n stems, c complex (2), d feature dimension."""
