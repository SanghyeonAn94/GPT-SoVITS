"""English text normalization for TTS: expands numbers, time, currency (£/$),
measurement units, decimals, fractions, and ordinals into spoken words.

Adapted from https://github.com/Cosmo-klara
"""
