...
from GPT_SoVITS.TTS_infer_pack.TTS_semantic import TTSSemantic
from GPT_SoVITS.TTS_infer_pack.TTS_vocoder import TTSVocoder
...
class TTS:
    def __init__(self, configs: Union[dict, str, TTS_Config]):
        ...
        self.semantic_processor = TTSSemantic(self)
        self.vocoder_processor = TTSVocoder(self)
