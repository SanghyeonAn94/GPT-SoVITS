"""ScaledAdam optimizer and BatchedOptimizer.

Copyright 2022 Xiaomi Corp. (authors: Daniel Povey). Licensed under the Apache License, Version 2.0;
see ../LICENSE. BatchedOptimizer stacks same-shape parameters to reduce optimizer kernel launches.
ScaledAdam scales each parameter's update by the norm of that parameter and learns the scale in log
space, subject to param_min_rms/param_max_rms limits.
"""
...
class BatchedOptimizer(Optimizer):
    ...
    def batched_params(self, param_group, group_params_names):
        ...
        batches_names = defaultdict(list)
